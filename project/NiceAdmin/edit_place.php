		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text-o"></i>Place</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" method="post" id="frm">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Name" value="<?php echo $fet->Name;?>" data-bvalidator="required,alpha">
                                      </div>
                                  </div>
                          <div class="form-group">
								...
								foreach($c as $r)
								{
									...
									?>
                                <option value="<?php echo $r->City_id;?>" selected="selected"><?php echo $r->City_name;?></option>
                                 <?php
								}
								else
								{
                               ...
                               <?php
								...
								?>
                                  ...
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="edit_place" value="Update">
                                  </div>
                              </form>
