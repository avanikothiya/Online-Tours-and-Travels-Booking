		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text-o"></i>State</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" method="post" id="frm">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="State_name" value="<?php echo $fet->State_name;?>" data-bvalidator="required,alpha">
                                      </div>
                                  </div>
                                
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="edit_state" value="Update">
                                  </div>
                              </form>
