...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-table"></i> Vehicle Type</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="fa fa-table"></i>Table</li>
						<li><i class="fa fa-th-list"></i>Vehicle Type</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <table class="table">
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $r->Minimum_charge;?></td> 
                                       <td><?php echo $r->Seat_mode;?></td> 
                                  <td><?php echo $r->Emp_name;?></td>
                                  <td><a href="edit_vehicle_type.php?Vehicle_type_id=<?php echo $r->Vehicle_type_id;?>"><img src="img/user_edit.png" alt="" title="" border="0" /></td>
                                  <td><a href="view_vehicle_type.php?vehicle_type_id=<?php echo $r->Vehicle_type_id;?>"><img src="img/trash.png" alt="" title="" border="0" /></a></td>
                              </tr>
                               <?php
								}
								?>
