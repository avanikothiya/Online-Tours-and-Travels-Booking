...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Add Vehicle</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-file-text-o"></i>Add Vehicle</li>
					</ol>
				</div>
			</div>
              <div class="row">
                               ...
                               <?php
								...
								?>
                                  ...
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="submit_vehicle" value="Add">
                                  </div>
                              </form>
