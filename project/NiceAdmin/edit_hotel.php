		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-file-text-o"></i>Edit Hotel</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" method="post" id="frm">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Hotel_name" value="<?php echo $fet->Hotel_name;?>" data-bvalidator="required,alpha">
                                      </div>
                                  </div>
                                    <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Charge" value="<?php echo $fet->Charge;?>" data-bvalidator="required,number">
                                      </div>
                                  </div>
                          <div class="form-group">
                               ...
                               <?php
								...
								?>
                                  ...
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="edit_hotel" value="Update">
                                  </div>
                              </form>
