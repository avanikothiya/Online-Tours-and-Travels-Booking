...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Add Package Detail</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-file-text-o"></i>Add Package Detail</li>
					</ol>
				</div>
			</div>
              <div class="row">
                               ...
                               <?php
								...
								?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                           <input id="cp1" type="date" size="16" class="form-control" name="Start_date" data-bvalidator="required">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">End Date</label>
                                      <div class="col-sm-10">
                                           <input id="cp1" type="date" size="16" class="form-control" name="End_date" data-bvalidator="required">
                                      </div>
                                  </div>
								  <div class="form-group">
                                      <label class="col-sm-2 control-label">Places</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Places" data-bvalidator="required">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Hotel</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Hotel" data-bvalidator="required">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Meal</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Meal" data-bvalidator="required">
                                      </div>
                                  </div>
								  <div class="form-group">
                                      <label class="col-sm-2 control-label">Price</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Price" data-bvalidator="required">
                                      </div>
                                  </div>
                                    <div class="form-group">
                                      <label class="col-sm-2 control-label">Overview</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Overview" data-bvalidator="required">
                                      </div>
                                  </div>
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="submit_package_detail" value="Add">
                                  </div>
                              </form>
