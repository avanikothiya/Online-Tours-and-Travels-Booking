...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Add Daily Route</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Forms</li>
						<li><i class="fa fa-file-text-o"></i>Add Daily Route</li>
					</ol>
				</div>
			</div>
              <div class="row">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" method="post" id="frm">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="From_place" data-bvalidator="required,alpha">
                                      </div>
                                  </div>
                                    <div class="form-group">
                                      <label class="col-sm-2 control-label">To Place</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="To_place" data-bvalidator="required,alpha">
                                      </div>
                                  </div>
                                   <div class="form-group">
                               ...
                               <?php
								...
								?>
								   ...
								   <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="time" class="form-control" name="Depart_time" data-bvalidator="required">
                                      </div>
									  </div>
									   <div class="form-group">
                                      <label class="col-sm-2 control-label">Arrive_time</label>
                                      <div class="col-sm-10">
                                          <input type="time" class="form-control" name="Arrive_time" data-bvalidator="required">
                                      </div>
                                 </div>
                                      ...
                                      <div class="col-sm-10">
                                          <input type="date" class="form-control" name="Date" data-bvalidator="required">
                                      </div>
									  </div>
									   <div class="form-group">
                                      <label class="col-sm-2 control-label">Price</label>
                                      <div class="col-sm-10">
                                          <input type="number" class="form-control" name="Price" data-bvalidator="required">
                                      </div>
									  </div>
									   <div class="form-group">
                                      <label class="col-sm-2 control-label">Via_route</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Via_route" data-bvalidator="required">
                                      </div>
									  </div>
									<div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="submit_daily_route_detail" value="Add">
                                  </div>
                              </form>
