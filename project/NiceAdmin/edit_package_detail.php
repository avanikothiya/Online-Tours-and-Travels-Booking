...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Edit Employee</h3>
					<ol class="breadcrumb">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <select class="form-control m-bot15" name="Package_name">
                                           <?php
								foreach($package_master as $r)
								{
									if($r->Package_id==$fet->Package_id)
									{
									?>
                                <option value="<?php echo $r->Package_id;?>" selected><?php echo $r->Package_name;?></option>
                               <?php
								}
								else
								{
                               ...
                               <?php
								...
								?>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                           <input id="cp1" type="date" size="16" class="form-control" name="Start_date" value="<?php echo $fet->Start_date;?>" data-bvalidator="required">
                                      </div>
                                  </div>
                                   <div class="form-group">
                                      <label class="col-sm-2 control-label">End Date</label>
                                      <div class="col-sm-10">
                                           <input id="cp1" type="date" size="16" class="form-control" name="End_date" value="<?php echo $fet->End_date;?>" data-bvalidator="required">
                                      </div>
                                  </div>
                            	  <div class="form-group">
                                      <label class="col-sm-2 control-label">Places</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Places" value="<?php echo $fet->Places;?> ">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Hotel</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Hotel" value="<?php echo $fet->Hotel;?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label"> Meal</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Meal" value="<?php echo $fet->Meal;?>">
                                      </div>
                                  </div>
                                     <div class="form-group">
                                      <label class="col-sm-2 control-label"> Price</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Price" value="<?php echo $fet->Price;?>">
                                      </div>
                                  </div>
                                     <div class="form-group">
                                      <label class="col-sm-2 control-label">Overview</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="Overview" value="<?php echo $fet->Overview;?>">
                                      </div>
                                  </div>
                                  <div class="form-group" align="center">
                                   <input type="submit" class="btn btn-primary" name="edit_package_detail" value="Update">
                                  </div>
                              </form>
