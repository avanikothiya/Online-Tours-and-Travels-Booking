...
<div id="wrapper">
			...
			<div class="big_photo" >
				<img src="NiceAdmin/master_img/<?php echo $r->master_img;?>" alt="" width="180" height="126" /><br><b><?php echo $r->Package_name?></b><br><font size="-1"><?php echo $r->Tour_name?></font><br><br><br></div>
